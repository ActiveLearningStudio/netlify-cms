    ...
    <div className="stats">
      <div className="content">
        ...
        <div className="all-blocks">
          <div className="block">
            <img className="stats-img" src={img1} alt="" />
          ...
          <div className="block">
            <img className="stats-img2" src={img2} alt="" />
          ...
          <div className="block">
            <img className="stats-img" src={img3} alt="" />
        ...
        <a className="stat-btn" href="#">
          ARTNERS CREATING WITH CURRIKI
        </a>
      </div>
    </div>
  );
